...
def grade_task1(
    ...
    total = round(max(0.01, min(0.99, (artifact_signal + fp_penalty + fn_penalty + 1.0) / 2.0)), 4)
...
def grade_task3(
    ...
    total = round(max(0.01, min(0.99, (bonus_norm + fp_penalty + missed_penalty + 1.0) / 2.0)), 4)
